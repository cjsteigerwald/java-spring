package com.steigerwald.landon.web.application;

import com.steigerwald.landon.business.domain.RoomReservation;
import com.steigerwald.landon.business.service.ReservationService;
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception{
        ...
        this.mockMvc.perform(get("/reservations?date=2017-01-01")).andExpect(status().isOk()).andExpect(
